<?php
/**
 * Bootstrap to wordPrees functions and definitions
 *
...
if ( ! function_exists( 'bootstrap2wordpress_setup' ) ) :
	...
	function bootstrap2wordpress_setup() {
		 ...
		 * If you're building a theme based on Bootstrap to wordPrees, use a find and replace
...
function bootstrap2wordpress_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Extra Siderbar', 'bootstrap2wordpress' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add widgets here.', 'bootstrap2wordpress' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
